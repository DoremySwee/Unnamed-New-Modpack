...
static wand as IItemStack = <appliedenergistics2:crank>; //<contenttweaker:pattern_wand>; //TODO:change the wand
...
scripts.libs.recipe.Transcript.ava.shaped(wand,scripts.libs.recipe.Mapping.read("
    ______@__;
    ___#_@$@_;
    ___#@$%$@;
    _##&#@$@_;
